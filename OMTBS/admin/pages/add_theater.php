...
<script type="text/javascript" src="../../validation/dist/js/bootstrapValidator.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-body">
            <form action="../backend/add_theater_process.php" method="post" id="form1">
              ...
              <div class="form-group">
                ...
                <input type="text" name="district" id="administrative_area_level_1" s placeholder="District" class="form-control">
