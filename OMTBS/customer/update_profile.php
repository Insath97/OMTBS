...
if (isset($_POST['registration'])) {
    ...
    $qry = "UPDATE `tbl_registration` SET `name`='$name',`email`='$email',`phone`='$phone',`age`='$age',`gender`='$gender',`password`='$hashedPassword' WHERE user_id ='$id'";
                                ...
                                <div class="card-body p-5">
                                    ...
                                    ?>
                                        <form class="mb-3 mt-md-4" method="post">
                                            ...
                                            <div class="mb-3">
                                                <?php $hashedPassword = md5($row['password']);
                                                ?>
                                                <input type="text" class="form-control" name="password" value="<?php echo $hashedPassword; ?>" required>
                                            </div>
