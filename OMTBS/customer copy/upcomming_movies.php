      ...
      <div class="wall my-5">
        ...
        <div class="row ">
          ...
          while ($row = mysqli_fetch_array($result)) {
            //   `name`, `cast`, `news_date`, `description`, `attachment
          ?>
            <div class="col-md-3">
              <div class="card">
                <img src="../admin/assets/<?php echo $row['attachment']; ?>" class="card-img-top" alt="Thumbnail Image">
                <div class="card-body">
                  <h5 class="card-title"><?php echo $row['name']; ?></h5>
                  <p class="card-text">Release Date : <?php echo $row['news_date']; ?></p>
                </div>
              </div>
            </div>
          <?php } ?>
